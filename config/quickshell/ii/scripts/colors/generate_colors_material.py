...
hex_to_argb = lambda hex_code: argb_from_rgb(int(hex_code.lstrip('#')[0:2], 16), int(hex_code.lstrip('#')[2:4], 16), int(hex_code.lstrip('#')[4:6], 16))
...
# Extended material
material_colors['success'] = material_colors['secondary']
material_colors['onSuccess'] = material_colors['onSecondary']
material_colors['successContainer'] = material_colors['secondaryContainer']
material_colors['onSuccessContainer'] = material_colors['onSecondaryContainer']
